...
-- INSERT EMPLOYEES
insert into employee (employeeID, first_name, last_name, email) values (1, 'John', 'Warton', 'warton@gmail.com');
insert into employee (employeeID, first_name, last_name, email) values (2, 'Mike', 'Lanister', 'lanister@gmail.com');
insert into employee (employeeID, first_name, last_name, email) values (3, 'Steve', 'Reeves', 'Reeves@gmail.com');
insert into employee (employeeID, first_name, last_name, email) values (4, 'Ronald', 'Connor', 'connor@gmail.com');
insert into employee (employeeID, first_name, last_name, email) values (5, 'Jim', 'Salvator', 'Sal@gmail.com');
insert into employee (employeeID, first_name, last_name, email) values (6, 'Peter', 'Henley', 'henley@gmail.com');
insert into employee (employeeID, first_name, last_name, email)values (7, 'Richard', 'Carson', 'carson@gmail.com');
insert into employee (employeeID, first_name, last_name, email) values (9, 'Tony', 'Roggers', 'roggers@gmail.com');
